<x-app-layout>
    ...
    <form action="{{ route('category.filter') }}" method="GET" class="flex justify-between mx-12 mt-6">
        ...
        <button type="submit" class="focus:outline-none text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 flex gap-2 items-center justify-center">
